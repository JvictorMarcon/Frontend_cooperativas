document.addEventListener("DOMContentLoaded", () => {
        ...
        activeList.forEach(item => {
            ...
            if (activeTab === "recebimento") {
                ...
                const metodoBadge = isEntrada && item.metodo_pagamento
                    ? `<span class="px-2 py-0.5 bg-blue-50 text-blue-700 rounded text-xs font-semibold uppercase">${item.metodo_pagamento}</span>`
    ...
    // Função para desenhar e atualizar os gráficos consolidando as cooperativas
